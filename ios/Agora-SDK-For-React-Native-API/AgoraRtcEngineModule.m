...
- (void)rtcEngine:(AgoraRtcEngineKit *)engine remoteVideoStats:(AgoraRtcRemoteVideoStats*)stats {
  [self sendEventWithName:RemoteVideoStats body:@{@"uid": @(stats.uid), @"width": @(stats.width), @"height": @(stats.height), @"receivedBitrate": @(stats.receivedBitrate), @"rxStreamType": @(stats.rxStreamType)}];
}
